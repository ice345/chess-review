  ...
  return <main className="page-scroll utility-page">
    ...
    <article className="help-content">
      ...
      <section id="first-review"><h2>Your first review</h2><ol>
        ...
        <li>Visit <Link href="/training">Practice</Link> to return to decisions from your own games. Add a task, start its source position, and say what each review was worth. Continue picks up whatever the schedule is waiting for, otherwise the first position you have not reviewed yet.</li>
