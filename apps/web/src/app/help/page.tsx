    ...
    <article className="help-content">
      ...
      <section id="your-data"><h2>Your data and connected services</h2>
        <dl className="data-destinations">
          ...
          <div><dt>Opening Explorer</dt><dd>When you open the Explorer panel in Engine Lab, the current position is sent to lichess.org&rsquo;s public opening explorer through this website&rsquo;s server, and the answer is cached in this browser. Only the position and the chosen database leave this machine — no game, PGN, username or account identifier — and the panel says so before you use it. Clearing the analysis cache also clears that cache.</dd></div>
