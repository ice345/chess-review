...
export default function HelpPage() {
  return <main className="page-scroll utility-page"><AppHeader />
    ...
    <article className="help-content">
      <nav aria-label="Help topics"><a href="#first-review">First review</a><a href="#capabilities">Capabilities</a><a href="#your-data">Your data</a><a href="#enhanced-local">Enhanced Local</a><a href="#feedback">Feedback</a></nav>
      ...
      <section id="capabilities"><h2>What is available</h2>
        ...
        <p>FEN studies have no game history, so use Engine Lab for position analysis. PGN is required for whole-game Accuracy and move-review history.</p>
      </section>
