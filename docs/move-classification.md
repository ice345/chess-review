...
Great means a critical engine-best choice identified with MultiPV. Only-legal moves, obvious recaptures and trivial check escapes are excluded. When excluded, an engine top move remains Best.
